...
- volume slider in the player-panel does not expend beyond the player-panel. Fix it

- set player-meta max-width to 60% or something. Currently, it is squishing the buttons to the right of it,

- the buttons in header-actions is not o the same height. Fix it.