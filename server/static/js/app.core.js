...
const spotifyLinkNextBtn = document.getElementById('spotify-link-next');
const spotifyLinkBackBtn = document.getElementById('spotify-link-back');
const spotifyLinkStep1 = document.getElementById('spotify-link-step-1');
const spotifyLinkStep2 = document.getElementById('spotify-link-step-2');
