...
const spInitVolValue = document.getElementById('sp-initvol-value');
...
let playlistsRecentlyPlayedCache = [];
let playlistsRecentlyPlayedFetchedAt = 0;
let playlistsRecentlyPlayedScopeMissing = false;
